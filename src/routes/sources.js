...
async function createSources(req, res, next) {
  try {
...
async function checkSources(req, res, next) {
  try {
...
router.get('/sources',authorization, getSources);

router.post('/create-source', authorization, createSources); 

router.post('/change-source', authorization, changeSource); 

router.post('/delete-source',   authorization, deleteSource);

router.post('/source', getSource);

router.post('/check-sources',authorization,checkSources);
